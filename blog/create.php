...
if (isset($_POST['add_post'])) {
    ...
    $query = "INSERT INTO blog (title, image, tagline, description) 
  			  VALUES('$title', '$imageToUpload', '$tagline', '$description')";
            ...
            <div class="container">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <label class="form-label">Tagline</label>
                        <textarea  name="tagline" class="form-control" required></textarea>
                    </div>
